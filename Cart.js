  ...
  return (
    <div>
      ...
      <Modal isOpen={isModalOpen} onRequestClose={handleCloseModal} >
        <div>
          {isCartValidated ? (
            <h2 className='orange'>Votre panier a bien été validé! </h2>
          ) : (
            <>
                  ...
                  return (
                    <li key={item.id}>
                      ...
                      <div>
                        ...
                        <br />
                        <span className='orange'><strong>Prix :</strong><strong> {item.price} €</strong></span>
                        <br />
                        <span className='turquoise'><strong>Quantité :</strong><strong> {itemQuantity}</strong></span>
                        <br />
                        <span className='orange'><strong>Total :</strong><strong> {itemTotal} €</strong></span>
              ...
              <div>
                <h3 className='orange'>Total Prix: {totalPrice} €</h3>
